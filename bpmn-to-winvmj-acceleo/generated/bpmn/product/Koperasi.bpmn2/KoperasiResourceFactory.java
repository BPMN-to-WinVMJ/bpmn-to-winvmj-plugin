...
public abstract class KoperasiResourceFactory {
	    private static final Logger LOGGER = Logger.getLogger(ResourceFactory.class.getName());

    public KoperasiResourceFactory()
    {

    }

    public static KoperasiResource createResource(String fullyQualifiedName, Object ... base)
    {
    	KoperasiResource record = null;
        if(true)
        {
        try {
