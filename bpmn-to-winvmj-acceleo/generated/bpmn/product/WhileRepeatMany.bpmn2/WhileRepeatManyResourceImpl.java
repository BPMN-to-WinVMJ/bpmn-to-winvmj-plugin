// @generated from WhileRepeatMany.bpmn2
...
public class WhileRepeatManyResourceImpl extends WhileRepeatManyResourceComponent {
    ...
    static interface WhileRepeatManyService {
    ...
    static class WhileRepeatManyServiceImpl implements WhileRepeatManyService {
	    @Override
	    ...
	    public void task2(Map<String, Object> requestBody, String processid, Map<String, Object> response) {
	        // TODO: Implement logic for task2
	...
	private static WhileRepeatManyService whilerepeatmanyService = new WhileRepeatManyServiceImpl();
    ...
    public Map<String, Object> userTask2(VMJExchange vmjExchange) {
		...
		whilerepeatmanyService.userTask2(requestBody, processid, response);
		boolean a = false;
		boolean b = false;
		boolean c = false;
		whilerepeatmanyService.task1(requestBody, processid, response);
		while (b || a) {
		    if (b) {
		    	processService.upsert(new ProcessInstance(processid, "b"));
		        whilerepeatmanyService.task4(requestBody, processid, response);
		    }
		    else if (a) {
		    	processService.upsert(new ProcessInstance(processid, "a"));
		        whilerepeatmanyService.task2(requestBody, processid, response);
		    }
		    whilerepeatmanyService.task1(requestBody, processid, response);
