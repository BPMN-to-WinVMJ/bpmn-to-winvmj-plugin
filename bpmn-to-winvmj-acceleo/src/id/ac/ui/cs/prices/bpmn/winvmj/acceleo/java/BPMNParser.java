...
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.*;
...
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.precond.EndPreCond;
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.precond.FlowPreCond;
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.precond.PickPreCond;
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.precond.PreCond;
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.precond.StartPreCond;
import id.ac.ui.cs.prices.bpmn.winvmj.acceleo.java.model.precond.SwitchPreCond;
...
public class BPMNParser {
    ...
    public static BPMN parse(org.eclipse.bpmn2.FlowElementsContainer process) throws Exception {
    	...
    	System.out.println("[DEBUG] process Id " + process.getId());
    	BPMN temp = new BPMN();
        try {
            ...
            if (fe instanceof SequenceFlow flow) {
                ...
                if (sourceElem instanceof Task && sourceElem.getOutgoing().size() > 1) {
                    throw new IllegalArgumentException(
                        "Task is branching: " + sourceElem.getId() + " " + sourceElem.getName());
                }
                if (targetElem instanceof Task && targetElem.getIncoming().size() > 1) {
                    throw new IllegalArgumentException(
                        "Task is branching: " + targetElem.getId() + " " + targetElem.getName());
                }
